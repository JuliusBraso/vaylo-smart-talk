-- Minimum Knowledge Factory taxonomy extension for retail banking
-- and payment-document lifecycle. Additive only: extends the
...
begin
  ...
  if v_definition not like '%banking_zahlungsverkehr%' then
    v_definition := replace(
      v_definition,
      $lit$'versicherungsvertraege_versicherungsschreiben'$lit$,
      $lit$'versicherungsvertraege_versicherungsschreiben','banking_zahlungsverkehr'$lit$
    );
