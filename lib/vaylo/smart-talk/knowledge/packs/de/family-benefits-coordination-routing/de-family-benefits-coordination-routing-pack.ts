...
export const DE_FAMILY_UNITS: readonly Unit[] = Object.freeze([
  ...
  { key: "de-fb-kg-self-employed-evidence", category: "procedure", type: "procedure", text: "Selbständige Erwerbstätigkeit im Kindergeldverfahren mit Auslandsbezug kann durch geeignete Nachweise wie Gewerbeanmeldung oder Steuerbescheid belegt werden.", sourceKey: "de-fb-kg-ausland", passageKey: "de-fb-kg-ausland-text", riskLevel: "high" },
  { key: "de-fb-kg-gewerbe-not-entitlement", category: "eligibility", type: "exception", text: "Die Gewerbeanmeldung ist nicht der Kindergeldanspruch.", sourceKey: "de-fb-kg-ausland", passageKey: "de-fb-kg-ausland-text", riskLevel: "high" },
  { key: "de-fb-kg-steuerbescheid-not-priority", category: "priority", type: "exception", text: "Der Steuerbescheid bestimmt nicht den unionsrechtlichen Vorrang nach Artikel 68.", sourceKey: "de-fb-kg-ausland", passageKey: "de-fb-kg-ausland-text", riskLevel: "high" },
