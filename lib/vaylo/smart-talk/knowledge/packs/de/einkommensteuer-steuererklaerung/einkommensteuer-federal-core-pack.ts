...
export const EST_OFFICIAL_SOURCES: readonly OfficialSourceSpec[] = Object.freeze([
  ...
  },
  {
    ...
    officialDomain: "www.gesetze-im-internet.de",
    title: "EStG § 50d Besonderheiten im Zusammenhang mit unbeschränkt Steuerpflichtigen, denen Abkommensvergünstigungen zustehen",
    sourceClass: "FEDERAL_LAW",
    sourceType: "federal_statute",
    retrievalMethod: "HTML_DOCUMENT",
    informationClass: "LEGAL_BASELINE",
    ...
    passages: [
      {
        key: "estg-50d-8",
        locator: "EStG § 50d Abs. 8",
        text: "Sind Einkünfte eines unbeschränkt Steuerpflichtigen aus nichtselbständiger Arbeit nach einem Abkommen zur Vermeidung der Doppelbesteuerung von der Bemessungsgrundlage der deutschen Steuer auszunehmen, wird die Freistellung bei der Veranlagung ungeachtet des Abkommens nur gewährt, soweit der Steuerpflichtige nachweist, dass der Staat, dem nach dem Abkommen das Besteuerungsrecht zusteht, auf dieses Besteuerungsrecht verzichtet hat oder dass die in diesem Staat auf die Einkünfte festgesetzten Steuern entrichtet wurden.",
      },
      {
        key: "estg-50d-9",
        locator: "EStG § 50d Abs. 9",
        text: "Sind Einkünfte eines unbeschränkt Steuerpflichtigen nach einem Abkommen zur Vermeidung der Doppelbesteuerung von der Bemessungsgrundlage der deutschen Steuer auszunehmen, so wird die Freistellung ungeachtet des Abkommens nicht gewährt, soweit der andere Staat die Bestimmungen des Abkommens so anwendet, dass die Einkünfte in diesem Staat von der Besteuerung auszunehmen sind, oder die Einkünfte in dem anderen Staat nur auf Antrag des Steuerpflichtigen von der Besteuerung auszunehmen sind. Die Vorschrift ändert nicht das abkommensrechtliche Besteuerungsrecht selbst.",
      },
    ],
  },
  {
...
export const EST_UNITS: readonly UnitSpec[] = Object.freeze([
  ...
  { key: "abmeldung-not-tax-non-residence", category: "tax_liability", temporal: "current_2026", type: "exception", text: "Die melderechtliche Abmeldung beendet den steuerlichen Wohnsitz nach § 8 AO nicht automatisch. Eine Person kann sich abmelden, während die für Beibehalten und Benutzen der Wohnung maßgeblichen Tatsachen fortbestehen.", sourceKey: "ao-8", passageKey: "ao-8-all", riskLevel: "high" },
  { key: "estg-1-3-not-wohnsitz-not-treaty-residence", category: "tax_liability", temporal: "current_2026", type: "exception", text: "Die Behandlung als unbeschränkt Steuerpflichtiger auf Antrag nach § 1 Absatz 3 EStG ist DEEMED_UNLIMITED_TAX_TREATMENT. Sie ist nicht deutscher Wohnsitz, nicht gewöhnlicher Aufenthalt und nicht automatisch deutsche Abkommensansässigkeit.", sourceKey: "estg-1", passageKey: "estg-1-1-4", riskLevel: "high" },
  { key: "wohnsitz-not-ownership-automatically", category: "tax_liability", temporal: "current_2026", type: "exception", text: "Eigentum, Mietvertrag oder Postanschrift allein sind nicht der steuerliche Wohnsitz für die Einkommensteuer. Sie können Beweisanzeichen sein; die gesetzliche Feststellung bleibt Beibehalten und Benutzen der Wohnung nach § 8 AO.", sourceKey: "ao-8", passageKey: "ao-8-all", riskLevel: "high" },
  { key: "ao-9-exactly-six-months-not-habitual", category: "tax_liability", temporal: "current_2026", type: "exception", text: "Ein zusammenhängender Aufenthalt von genau sechs Monaten begründet regelmäßig noch nicht den gewöhnlichen Aufenthalt. Die gesetzliche Regel knüpft an mehr als sechs Monate an. Kurzfristige Unterbrechungen bleiben unberücksichtigt.", sourceKey: "ao-9", passageKey: "ao-9-all", riskLevel: "high" },
  { key: "ao-9-not-article15-183", category: "cross_border", temporal: "current_2026", type: "exception", text: "Der deutsche gewöhnliche Aufenthalt nach § 9 AO (mehr als sechs Monate) ist nicht der 183-Tage-Test des DBA Deutschland-Slowakei Artikel 15. Die Zähler sind getrennt. Er ist auch nicht der slowakische inländische 183-Tage-Test.", sourceKey: "ao-9", passageKey: "ao-9-all", riskLevel: "high" },
  { key: "estg-50d-8-employment-exemption-proof", category: "cross_border", temporal: "current_2026", type: "procedure", text: "Soll ausländischer Arbeitslohn nach einem DBA von der deutschen Bemessungsgrundlage der Einkommensteuer ausgenommen werden, gewährt die Veranlagung die Freistellung nach § 50d Absatz 8 EStG nur, soweit nachgewiesen ist, dass der andere Staat auf das Besteuerungsrecht verzichtet hat oder die dort festgesetzte Steuer entrichtet wurde. FOREIGN_TAX_PROOF_REQUIRED. Abkommensfreistellung ist nicht automatisch deutsche Veranlagungsfreistellung.", sourceKey: "estg-50d", passageKey: "estg-50d-8", riskLevel: "high", requiredContextKeys: ["COUNTRY", "RESIDENCE_STATE", "WORK_STATE"] },
  { key: "estg-50d-8-not-taxing-right", category: "cross_border", temporal: "current_2026", type: "exception", text: "§ 50d Absatz 8 EStG entscheidet nicht, welcher Staat das abkommensrechtliche Besteuerungsrecht hat. Zuerst Artikel 15, dann Artikel 23, dann die inländische Umsetzung für die Einkommensteuer. GERMAN_DOMESTIC_SWITCHOVER_CHECK und Nachweis sind Umsetzungsgrenzen, keine Quellenstaatsregeln.", sourceKey: "estg-50d", passageKey: "estg-50d-8", riskLevel: "high" },
  { key: "estg-50d-9-switchover-gate", category: "cross_border", temporal: "current_2026", type: "procedure", text: "§ 50d Absatz 9 EStG kann die Abkommensfreistellung in der Einkommensteuer in bestimmten Konflikt- oder Nichtbesteuerungslagen versagen. Vor einer endgültigen deutschen Freistellungsklassifikation ist GERMAN_DOMESTIC_SWITCHOVER_CHECK erforderlich. Die Vorschrift ändert nicht selbst das abkommensrechtliche Besteuerungsrecht.", sourceKey: "estg-50d", passageKey: "estg-50d-9", riskLevel: "high", requiredContextKeys: ["COUNTRY", "PROCESS_VARIANT"] },
...
export const EST_PROCESS_BINDINGS: readonly EstBindingSpec[] = Object.freeze([
  ...
  { processKey: "steuerpflicht-gate", role: "orientation_basis", sequenceContext: "status", claimKeys: ["unlimited-if-wohnsitz-or-aufenthalt", "wohnsitz-definition", "gewoehnlicher-aufenthalt-definition", "limited-if-domestic-income", "section-1-3-request-boundary", "estg-1-3-not-wohnsitz-not-treaty-residence"] },
  { processKey: "steuerpflicht-gate", role: "negative_control", sequenceContext: "status_not", qualificationRequired: true, claimKeys: ["anmeldung-not-tax-residence", "abmeldung-not-tax-non-residence", "wohnsitz-not-ownership-automatically", "ao-9-exactly-six-months-not-habitual", "ao-9-not-article15-183", "german-address-not-complete-residence", "living-abroad-not-automatic-no-est", "working-germany-not-automatic-unlimited", "nationality-not-tax-residence", "userlocale-not-jurisdiction", "dual-residence-fail-closed"] },
  ...
  { processKey: "ausland-gate", role: "orientation_basis", sequenceContext: "ausland", claimKeys: ["limited-if-domestic-income", "progression-replacement-income", "tax-free-not-irrelevant-to-rate", "progression-not-ordinary-taxable", "estg-50d-8-employment-exemption-proof", "estg-50d-9-switchover-gate"] },
  { processKey: "ausland-gate", role: "context_gate", sequenceContext: "ausland_not", qualificationRequired: true, claimKeys: ["foreign-income-not-automatically-tax-free", "foreign-tax-paid-not-nothing-to-declare", "german-employer-not-exclusive-right", "estg-50d-8-not-taxing-right", "eu-citizen-not-special-universal-tax", "treaty-result-fail-closed", "dual-residence-fail-closed", "alg-pack-is-separate", "health-pack-is-separate", "kindergeld-pack-is-separate"] },
