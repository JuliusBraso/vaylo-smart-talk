...
export const SK_UNEMPLOYMENT_ADAPTER_PACK_ID = "sk_unemployment_coordination_adapter" as const;
export const SK_UNEMPLOYMENT_ADAPTER_PROCESS_GROUP = "sk_unemployment_coordination_adapter" as const;
...
export const DE_UNEMPLOYMENT_ROUTING_PACK_ID = "de_unemployment_coordination_routing" as const;
export const DE_UNEMPLOYMENT_ROUTING_PROCESS_GROUP = "de_unemployment_coordination_routing" as const;
...
export const DE_SK_UNEMPLOYMENT_CONNECTOR_PROCESS_GROUP = "de_sk_unemployment_coordination_connector" as const;
...
export type CuratedForeignNationalAdapterPack = Readonly<{
  schemaVersion: 1;
  packId:
    | typeof SK_ADAPTER_PACK_ID
    | typeof SK_HEALTH_ADAPTER_PACK_ID
    | typeof SK_FAMILY_ADAPTER_PACK_ID
    | typeof SK_UNEMPLOYMENT_ADAPTER_PACK_ID;
