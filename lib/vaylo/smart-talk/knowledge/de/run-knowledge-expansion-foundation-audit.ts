...
async function main(): Promise<void> {
  ...
  try {
    ...
    cases.F54 = KNOWLEDGE_FACTORY_DOMAINS.length === 17
      ...
      && (KNOWLEDGE_FACTORY_DOMAINS as readonly string[]).includes("verkehrsordnungswidrigkeiten_bussgeldverfahren")
      && (KNOWLEDGE_FACTORY_DOMAINS as readonly string[]).includes("elterngeld");
