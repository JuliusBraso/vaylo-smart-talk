const tr = {
  ...
  nav: { navigation: "Gezinme", home: "Ana sayfa", tasks: "Görevlerim", history: "Geçmiş", profile: "Profil", dashboard: "Panel", assistant: "Asistan", letters: "Yazışmalar", forms: "Formlar", guides: "Rehberler", documents: "Belgeler", phrases: "Cümleler", jobs: "İş", taxes: "Vergi", settings: "Ayarlar", premium: "Premium" },
  onboarding: {
  ...
  settings: { title: "Ayarlar", appLanguage: "Uygulama dili", hint: "Tüm uygulama bu dilde gösterilir.", personal: "Kişisel" },
  phrases: {
    title: "Cümle sözlüğü",
