const hu = {
  ...
  documents: {
    ...
    urgencyLow: "Alacsony",
    fromDashboardStepHint: "A dashboard lépéséhez kapcsolva",
    intelligenceSectionTitle: "Dokumentum-intelligencia",
    intelligenceSectionSubtitle: "Osztályozási eredmények és kapcsolt lépések.",
    intelligenceUnavailable: "A dokumentum-intelligencia most nem érhető el.",
    intelligenceStatusLine: "Elemzés állapota: {status}",
    intelligenceStatusPending: "Folyamatban",
    intelligenceStatusCompleted: "Kész",
    intelligenceStatusUnknown: "Ismeretlen",
    intelligenceStatusFailed: "Sikertelen",
    intelligenceMatchedType: "Felismert típús: {slug} ({key})",
    intelligenceLinkedStep: "Kapcsolt lépés: {link} -> {stepKey} (téma: {topicKey})",
    intelligenceNoCatalogMatch: "Nincs találat a dokumentum-katalógusban.",
    intelligenceConfidenceLine: "Bizonyosság: {value}%",
    intelligenceMethodLine: "Módszer: {value}",
    intelligenceSenderLine: "Feladó: {value}",
    intelligenceDateLine: "Dátum: {value}",
    intelligenceSummaryLine: "Összefoglaló: {value}",
    intelligenceClassificationFailed: "Az osztályozás sikertelen. Próbáld újra később.",
    intelligenceTypeWithoutLinks: "A dokumentumtípus felismert, de nincs kapcsolt lépés.",
    intelligencePendingDetail: "Az elemzés még fut. Frissíts rövidesen.",
    proofSectionTitle: "Lépés megerősítése",
    proofSectionSubtitle: "Erősítsd meg vagy utasítsd el a dokumentum javasolt hatását.",
    proofSuggestionLine: "Ez a dokumentum megerősítheti ezt a lépést: {stepId}",
    proofConfirmButton: "Megerősítés",
    proofRejectButton: "Elutasítás",
    proofNotEligible: "Ehhez a lépéshez most nem adható megerősítés.",
    proofStateConfirmed: "A lépés megerősítve.",
    proofStateRejected: "A megerősítés elutasítva.",
    proofStateProgress: "Lépésállapot frissítése…",
    proofStateProfile: "A profilod már tükrözi ezt.",
    proofWorking: "Mentés…",
    proofError: "Nem sikerült menteni. Próbáld újra.",
  },
  documentDetail: {
    untitled: "Névtelen",
    download: "Letöltés",
