const pl = {
  ...
  nav: { navigation: "Nawigacja", home: "Start", tasks: "Moje zadania", history: "Historia", profile: "Profil", dashboard: "Panel", assistant: "Asystent", letters: "Listy", forms: "Formularze", guides: "Przewodniki", documents: "Dokumenty", phrases: "Zwroty", jobs: "Praca", taxes: "Podatki", settings: "Ustawienia", premium: "Premium" },
  onboarding: {
  ...
  settings: { title: "Ustawienia", appLanguage: "Język aplikacji", hint: "Cała aplikacja będzie w tym języku.", personal: "Osobiste" },
  phrases: {
