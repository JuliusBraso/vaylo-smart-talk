const pl = {
  ...
  common: {
    employment_freelancer: "Freelancer / działalność",
    employment_employee: "Pracownik",
    employment_job_seeker: "Szukam pracy",
    family_single: "Sam / sama",
    family_family: "Para / rodzina (bez dzieci)",
    family_children: "Rodzina z dziećmi",
    language_A1: "A1",
    language_A2: "A2",
    language_B1: "B1",
    language_B2: "B2",
    language_C1: "C1",
    goal_bureaucracy: "Biurokracja i urzędy",
    goal_job: "Praca i aplikacje",
    goal_orientation: "Orientacja i codzienność",
  },
