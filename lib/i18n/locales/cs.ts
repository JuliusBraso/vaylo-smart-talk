const cs = {
  ...
  nav: { navigation: "Navigace", home: "Domů", tasks: "Moje úkoly", history: "Historie", profile: "Profil", dashboard: "Přehled", assistant: "Asistent", letters: "Dopisy", forms: "Formuláře", guides: "Návody", documents: "Dokumenty", phrases: "Slovník", jobs: "Práce", taxes: "Daně", settings: "Nastavení", premium: "Premium" },
  onboarding: {
  ...
  settings: { title: "Nastavení", appLanguage: "Jazyk aplikace", hint: "Celá aplikace se zobrazí v tomto jazyce.", personal: "Osobní" },
  phrases: {
    title: "Slovník frází",
