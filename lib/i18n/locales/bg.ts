const bg = {
  ...
  nav: { navigation: "Навигация", home: "Начало", tasks: "Моите задачи", history: "История", profile: "Профил", dashboard: "Табло", assistant: "Асистент", letters: "Писма", forms: "Формуляри", guides: "Ръководства", documents: "Документи", phrases: "Фрази", jobs: "Работа", taxes: "Данъци", settings: "Настройки", premium: "Premium" },
  onboarding: {
  ...
  documents: {
    ...
    urgencyLow: "Ниска",
    fromDashboardStepHint: "From dashboard step",
    intelligenceSectionTitle: "Document intelligence",
    intelligenceSectionSubtitle: "Classification results and linked steps.",
    intelligenceUnavailable: "Document intelligence is unavailable right now.",
    intelligenceStatusLine: "Analysis status: {status}",
    intelligenceStatusPending: "Pending",
    intelligenceStatusCompleted: "Completed",
    intelligenceStatusUnknown: "Unknown",
    intelligenceStatusFailed: "Failed",
    intelligenceMatchedType: "Matched document type: {slug} ({key})",
    intelligenceLinkedStep: "Linked step: {link} -> {stepKey} (topic: {topicKey})",
    intelligenceNoCatalogMatch: "No catalog match found.",
    intelligenceConfidenceLine: "Confidence: {value}%",
    intelligenceMethodLine: "Method: {value}",
    intelligenceSenderLine: "Sender: {value}",
    intelligenceDateLine: "Document date: {value}",
    intelligenceSummaryLine: "Summary: {value}",
    intelligenceClassificationFailed: "Classification failed. Please try again later.",
    intelligenceTypeWithoutLinks: "Document type matched, but no linked steps exist.",
    intelligencePendingDetail: "Analysis is still running. Refresh shortly.",
    proofSectionTitle: "Step confirmation",
    proofSectionSubtitle: "Confirm or reject the suggested effect of this document.",
    proofSuggestionLine: "This document may confirm step: {stepId}",
    proofConfirmButton: "Confirm",
    proofRejectButton: "Reject",
    proofNotEligible: "This step is not eligible for proof confirmation right now.",
    proofStateConfirmed: "Step confirmed.",
    proofStateRejected: "Confirmation rejected.",
    proofStateProgress: "Updating step status…",
  ...
  settings: { title: "Настройки", appLanguage: "Език на приложението", hint: "Цялото приложение ще се показва на този език.", personal: "Лични" },
  phrases: {
