...
const en = {
  ...
  dashboard: {
    ...
    heroGreeting: "Good day! 👋",
    heroQuestion: "What should we handle today?",
    heroInputPlaceholder: "Describe what you need to handle...",
    environmentLabel: "Environment: {region}",
    smartMode: "Smart mode",
    recentDocumentsTitle: "Recent documents",
    noRecentDocuments: "You have not uploaded documents yet.",
    viewAllDocuments: "View all documents",
    helpTitle: "How can I help?",
    helpQuestionAnmeldung: "Which documents do I need for Anmeldung?",
    helpQuestionTaxId: "How does the German tax ID work?",
    helpQuestionKindergeld: "Am I eligible for Kindergeld?",
    helpQuestionHealthInsurance: "How do I choose health insurance?",
    moreQuestions: "More questions",
    notificationsLabel: "Notifications",
    activityLabel: "Activity",
    backgroundTitle: "Background",
    backgroundDescription: "Choose a background that inspires you.",
    vibeSunset: "Sunset",
    vibeAlpine: "Mountains",
    vibeNight: "Dark",
    vibeMinimal: "Minimal",
    importantTasksTitle: "Your most important tasks",
    viewAllTasks: "View all tasks",
    historyTitle: "Completed & automated",
    historyToggleTitle: "Show completed and auto-resolved steps",
    show: "Show",
    hide: "Hide",
    privacyNote: "Vaylo protects your data. Learn more about security.",
    profileCardTitle: "Your profile",
    registrationLabel: "Registration",
    requiresPrerequisites: "Requires prerequisite steps",
    autoResolvedTooltip: "Automatically resolved based on your data",
    completedTooltip: "Completed",
    alreadyCompletedTooltip: "Already completed based on your data",
    missingInfoTooltip: "Complete your profile to unlock",
  ...
  knowledge: {
    ...
    "topics.relocation_basics.title": "Relocation basics",
    "topics.relocation_basics.description":
      "Registration, tax ID, bank account, and insurance for settling in Germany.",
    "steps.relocation_basics.anmeldung.title": "Register your address (Anmeldung)",
    "steps.relocation_basics.tax_id.title": "Receive your tax ID (Steuer-ID)",
    "steps.relocation_basics.health_insurance.title": "Arrange health insurance",
    "steps.relocation_basics.health_insurance_public.title": "Arrange public health insurance",
    "steps.relocation_basics.health_insurance_private.title": "Arrange private health insurance",
    "steps.relocation_basics.bank_account.title": "Open a German bank account",
    "steps.relocation_basics.tax_office_visit.title": "Contact the tax office",
    "steps.identity_verification.passport.title": "Prepare your passport",
    "steps.identity_verification.eu_identity_card.title": "Prepare your EU identity card",
    "steps.identity_verification.identity_verification.title": "Verify your identity",
    "steps.family_benefits.kindergeld.title": "Apply for Kindergeld",
    "steps.family_benefits.elterngeld.title": "Apply for Elterngeld",
    "steps.financial_setup.public_health_insurance.title": "Choose public health insurance",
    "steps.financial_setup.private_health_insurance.title": "Choose private health insurance",
    "steps.financial_setup.social_security_number.title": "Receive your social security number",
