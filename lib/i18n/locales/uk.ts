const uk = {
  ...
  nav: { navigation: "Навігація", home: "Додому", tasks: "Мої завдання", history: "Історія", profile: "Профіль", dashboard: "Головна", assistant: "Асистент", letters: "Листи", forms: "Форми", guides: "Гайди", documents: "Документи", phrases: "Фрази", jobs: "Робота", taxes: "Податки", settings: "Налаштування", premium: "Premium" },
  onboarding: {
  ...
  settings: { title: "Налаштування", appLanguage: "Мова застосунку", hint: "Увесь застосунок буде цією мовою.", personal: "Особисте" },
  phrases: {
    title: "Словник фраз",
