const ru = {
  ...
  nav: { navigation: "Навигация", home: "Главная", tasks: "Мои задачи", history: "История", profile: "Профиль", dashboard: "Главная", assistant: "Ассистент", letters: "Письма", forms: "Формы", guides: "Гайды", documents: "Документы", phrases: "Фразы", jobs: "Работа", taxes: "Налоги", settings: "Настройки", premium: "Premium" },
  onboarding: {
  ...
  settings: { title: "Настройки", appLanguage: "Язык приложения", hint: "Всё приложение отображается на этом языке.", personal: "Личное" },
  phrases: {
    title: "Словарь фраз",
