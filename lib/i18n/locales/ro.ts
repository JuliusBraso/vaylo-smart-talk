const ro = {
  ...
  nav: { navigation: "Navigare", home: "Acasă", tasks: "Sarcinile mele", history: "Istoric", profile: "Profil", dashboard: "Dashboard", assistant: "Asistent", letters: "Scrisori", forms: "Formulare", guides: "Ghiduri", documents: "Documente", phrases: "Fraze", jobs: "Joburi", taxes: "Taxe", settings: "Setări", premium: "Premium" },
  onboarding: {
    ...
    continue: "Continuă",
    privacyNote:
      "Vaylo îți protejează datele. Află mai multe despre securitate.",
  ...
  documents: {
    ...
    intelligenceStatusPending: "În curs",
    ...
    proofStateProfile: "Profilul tău reflectă deja acest lucru.",
    proofWorking: "Salvare…",
    proofError: "Nu s-a putut salva. Încearcă din nou.",
  },
  documentDetail: {
    untitled: "Fără titlu",
    download: "Descarcă",
  ...
  dashboard: {
    ...
    heroGreeting: "Bună ziua! 👋",
    heroQuestion: "Ce rezolvăm azi?",
    heroInputPlaceholder: "Descrie ce vrei să rezolvi…",
    environmentLabel: "Mediu: {region}",
    smartMode: "Mod inteligent",
    recentDocumentsTitle: "Documente recente",
    noRecentDocuments: "Nu ai încărcat documente până acum.",
    viewAllDocuments: "Vezi toate documentele",
    helpTitle: "Cu ce te pot ajuta?",
    helpQuestionAnmeldung: "Ce documente trebuie pentru Anmeldung?",
    helpQuestionTaxId: "Cum funcționează codul fiscal german?",
    helpQuestionKindergeld: "Am dreptul la Kindergeld?",
    helpQuestionHealthInsurance: "Cum aleg asigurarea de sănătate?",
    moreQuestions: "Mai multe întrebări",
    notificationsLabel: "Notificări",
    activityLabel: "Activitate",
    backgroundTitle: "Fundal",
    backgroundDescription: "Alege un fundal care te inspiră.",
    vibeSunset: "Apus",
    vibeAlpine: "Munți",
    vibeNight: "Întunecat",
    vibeMinimal: "Minimal",
    importantTasksTitle: "Sarcinile tale principale",
    viewAllTasks: "Vezi toate sarcinile",
    historyTitle: "Finalizate și automatizate",
    historyToggleTitle: "Arată pașii finalizați și rezolvați automat",
    show: "Arată",
    hide: "Ascunde",
    privacyNote: "Vaylo îți protejează datele. Află mai multe despre securitate.",
    profileCardTitle: "Profilul tău",
    registrationLabel: "Înregistrare",
    requiresPrerequisites: "Necesită pași anteriori",
    autoResolvedTooltip: "Rezolvat automat pe baza datelor tale",
    completedTooltip: "Finalizat",
    alreadyCompletedTooltip: "Deja finalizat pe baza datelor tale",
    missingInfoTooltip: "Completează profilul pentru deblocare",
    ...
    actionSituationSummary: "Profil: {employment} · {goal} · {language}",
    ...
    actionMarkDone: "Gata",
    stepProcessVerified: "Verificat",
    stepProcessCompleted: "Finalizat",
    stepProcessEligible: "Disponibil",
    stepProcessBlocked: "Așteptare",
    stepProcessInProgress: "În curs",
    stepProcessBlockedHint: "Finalizează mai întâi pașii anteriori",
    stepProcessNotApplicable: "Nu se aplică situației tale",
    stepProcessProofBacked: "Confirmat cu document",
    stepRecommendedNext: "Pasul următor recomandat",
    autoByVaylo: "Auto by Vaylo",
    autoByVayloTooltip: "Finalizat automat pe baza documentelor tale",
    confidence: "Precizie",
    documentAnalyzingHint: "Se analizează documentul…",
    ...
    freelancerTitle: "Tablou freelancer",
    ...
    jobSeekerTitle: "Secțiune joburi",
    ...
    reset: "Resetare ghid inițial",
  },
  settings: { title: "Setări", appLanguage: "Limba aplicației", hint: "Toată aplicația va fi în această limbă.", personal: "Personal" },
  phrases: {
