const sk = {
  ...
  nav: { navigation: "Navigácia", home: "Domov", tasks: "Moje úlohy", history: "História", profile: "Profil", dashboard: "Prehľad", assistant: "Asistent", letters: "Listy", forms: "Formuláre", guides: "Návody", documents: "Dokumenty", phrases: "Slovník", jobs: "Práca", taxes: "Dane", settings: "Nastavenia", premium: "Premium" },
  onboarding: {
  ...
  dashboard: {
    ...
    heroGreeting: "Dobrý deň! 👋",
    heroQuestion: "Čo by sme dnes mali vybaviť?",
    heroInputPlaceholder: "Opíšte, čo potrebujete vybaviť...",
    environmentLabel: "Prostredie: {region}",
    smartMode: "Smart režim",
    recentDocumentsTitle: "Nedávne dokumenty",
    noRecentDocuments: "Zatiaľ nemáte nahrané dokumenty.",
    viewAllDocuments: "Zobraziť všetky dokumenty",
    helpTitle: "Ako vám môžem pomôcť?",
    helpQuestionAnmeldung: "Aké doklady potrebujem na Anmeldung?",
    helpQuestionTaxId: "Ako funguje daňové číslo v Nemecku?",
    helpQuestionKindergeld: "Mám nárok na Kindergeld?",
    helpQuestionHealthInsurance: "Ako si vybrať zdravotné poistenie?",
    moreQuestions: "Ďalšie otázky",
    notificationsLabel: "Upozornenia",
    activityLabel: "Aktivita",
    backgroundTitle: "Pozadie",
    backgroundDescription: "Vyberte si pozadie, ktoré vás inšpiruje.",
    vibeSunset: "Sunset",
    vibeAlpine: "Hory",
    vibeNight: "Tmavé",
    vibeMinimal: "Minimal",
    importantTasksTitle: "Vaše najdôležitejšie úlohy",
    viewAllTasks: "Zobraziť všetky úlohy",
    historyTitle: "Dokončené a automatizované",
    historyToggleTitle: "Zobraziť dokončené a automaticky vyriešené kroky",
    show: "Zobraziť",
    hide: "Skryť",
    privacyNote: "Vaylo chráni vaše dáta. Viac o bezpečnosti.",
    profileCardTitle: "Váš profil",
    registrationLabel: "Registrácia",
    requiresPrerequisites: "Vyžaduje predchádzajúce kroky",
    autoResolvedTooltip: "Automaticky vyriešené podľa tvojich dát",
    completedTooltip: "Dokončené",
    alreadyCompletedTooltip: "Už dokončené podľa tvojich dát",
    missingInfoTooltip: "Doplň profil na odomknutie",
  ...
  settings: { title: "Nastavenia", appLanguage: "Jazyk aplikácie", hint: "Celá aplikácia sa zobrazí v tomto jazyku.", personal: "Osobné" },
  phrases: {
    title: "Slovník viet",
  ...
  knowledge: {
    ...
    "topics.relocation_basics.title": "Prvé kroky po príchode",
    "topics.relocation_basics.description":
      "Registrácia, daňové ID, účet a poistenie pre štart v Nemecku.",
    "steps.relocation_basics.anmeldung.title": "Zaregistruj adresu (Anmeldung)",
    "steps.relocation_basics.tax_id.title": "Získaj daňové číslo (Steuer-ID)",
    "steps.relocation_basics.health_insurance.title": "Vybav zdravotné poistenie",
    "steps.relocation_basics.health_insurance_public.title":
      "Vybav verejné zdravotné poistenie",
    "steps.relocation_basics.health_insurance_private.title":
      "Vybav súkromné zdravotné poistenie",
    "steps.relocation_basics.bank_account.title": "Otvor nemecký bankový účet",
    "steps.relocation_basics.tax_office_visit.title": "Kontaktuj Finanzamt",
    "steps.identity_verification.passport.title": "Priprav cestovný pas",
    "steps.identity_verification.eu_identity_card.title": "Priprav občiansky preukaz EÚ",
    "steps.identity_verification.identity_verification.title": "Over totožnosť",
    "steps.family_benefits.kindergeld.title": "Požiadaj o Kindergeld",
    "steps.family_benefits.elterngeld.title": "Požiadaj o Elterngeld",
    "steps.financial_setup.public_health_insurance.title":
      "Vyber verejné zdravotné poistenie",
    "steps.financial_setup.private_health_insurance.title":
      "Vyber súkromné zdravotné poistenie",
    "steps.financial_setup.social_security_number.title": "Získaj číslo sociálneho poistenia",
